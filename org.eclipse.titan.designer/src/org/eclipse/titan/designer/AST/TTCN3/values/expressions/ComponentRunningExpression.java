 ...
 * */
public final class ComponentRunningExpression extends Expression_Value {
	...
	public ComponentRunningExpression(final IValue value, final Reference index_redirection, final boolean anyFrom) {
		this.value = value;
