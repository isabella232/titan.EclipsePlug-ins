...
public final class ControlPart extends Scope implements ILocateableNode, IAppendableSyntax {
	...
	public void addProposal(final ProposalCollector propCollector) {
		for (final SkeletonTemplateProposal templateProposal : TTCN3CodeSkeletons.CONTROL_PART_FUNCTIONS) {
	...
	public void generateCode( final JavaGenData aData ) {
		...
		getLocation().create_location_object(aData, sb, "CONTROLPART", getModuleScope().getIdentifier().getDisplayName());
