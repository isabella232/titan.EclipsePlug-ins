 ...
 */
public class AllPortCheckSateExpression extends Expression_Value {
	private static final String OPERAND1_ERROR1 = "The operand of the `all port.checkstate' operation should be a charstring";
	...
	public AllPortCheckSateExpression(final Value aValue) {
		this.value = aValue;
	...
	public Operation_type getOperationType() {
		return Operation_type.ALL_CHECKSTATE_OPERATION;
	}
