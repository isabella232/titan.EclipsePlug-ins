...
public final class SequenceOf_Type extends AbstractOfType implements IReferenceableElement {
	...
	public void generateCode( final JavaGenData aData, final StringBuilder source ) {
		...
		case TYPE_INTEGER:
			...
			source.append(MessageFormat.format("\tpublic static class {0} extends PreGenRecordOf.PREGEN__RECORD__OF__INTEGER{1} '{'\n", genName, optimized_memalloc ? "__OPTIMIZED" : ""));
			...
			source.append("}\n");
			source.append("}\n");
			source.append(MessageFormat.format("\tpublic static class {0}_template extends PreGenRecordOf.PREGEN__RECORD__OF__INTEGER{1}_template '{'\n", genName, optimized_memalloc ? "__OPTIMIZED" : ""));
			...
			source.append("list_value = new ArrayList<PreGenRecordOf.PREGEN__RECORD__OF__INTEGER_template>( list_length );\n");
