 ...
 */
public final class Json2CborExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `json2cbor' operation should be an universal charstring value";

	private final Value value;

	public Json2CborExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.JSON2CBOR_OPERATION;
	}
	...
	public String createStringRepresentation() {
		...
		builder.append("json2cbor(").append(value.createStringRepresentation()).append(')');
	...
	public void generateCodeExpressionExpression(final JavaGenData aData, final ExpressionStruct expression) {
		...
		expression.expression.append("AdditionalFunctions.json2cbor(");
