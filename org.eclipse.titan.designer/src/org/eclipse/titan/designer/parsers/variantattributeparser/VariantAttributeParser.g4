...
{ jsonstruct.parsed_default_value = $value.v; jsonstruct.defaultLocation = getLocation( $value.start, $value.stop );};
...
pr_JDefault: DEFAULTKeyword value = pr_JsonValue { jsonstruct.parsed_default_value = $value.v; jsonstruct.defaultLocation = getLocation( $value.start, $value.stop );};
