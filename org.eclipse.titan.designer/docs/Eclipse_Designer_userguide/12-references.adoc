...
[[_2]]
* [2] link:https://github.com/eclipse/titan.EclipsePlug-ins/blob/master/org.eclipse.titan.designer/docs/Eclipse_Designer_userguide/DesignerUserGuide.adoc[Installation Guide for TITAN Designer and TITAN Executor for the Eclipse IDE]
