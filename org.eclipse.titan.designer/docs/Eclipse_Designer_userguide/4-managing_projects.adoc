...
Once the new folder created, you shall see something like shown on Figure <<new-file-created,New file created>>  (without the filename file1.ttcn).
...
Wizards are available to create some of the TITAN modulesfootnote:[The terms "modules" and "files" are used interchangeably in this section.] (TTCN-3, ASN.1 and Configuration files). This functionality is reached by selecting *File / New* ( see figure <<new-resources-menu,New resources menu>>).
