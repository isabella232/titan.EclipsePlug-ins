...
. Create an empty project without src subfolder according to <<creating-a-new-titan-project, this section>>. The project name should be the same as the name of the project to be imported.
