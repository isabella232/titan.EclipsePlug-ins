...
2. Enter project name and location (see Figure 27).By default, the project will be created in the directory of the workbench. It is not recommended to select a path that contains special characters (like the spaces in ``Documents and Settings'').
+
