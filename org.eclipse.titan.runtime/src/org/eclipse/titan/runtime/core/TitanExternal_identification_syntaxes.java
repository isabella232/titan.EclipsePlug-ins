...
public class TitanExternal_identification_syntaxes extends Base_Type {
	 ...
	 * */
	public static TitanInteger TitanExternal_identification_syntaxes_decoder( final TitanOctetString input_stream, final TitanExternal_identification_syntaxes output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static TitanInteger TitanExternal_identification_syntaxes_abstract__decoder( final TitanOctetString input_stream, final TitanObjectid output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static TitanInteger TitanExternal_identification_syntaxes_transfer_decoder( final TitanOctetString input_stream, final TitanObjectid output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
