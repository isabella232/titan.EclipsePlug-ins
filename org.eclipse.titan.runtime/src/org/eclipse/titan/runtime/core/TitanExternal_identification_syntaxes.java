...
public class TitanExternal_identification_syntaxes extends Base_Type {
	public static final TTCN_JSONdescriptor TitanExternal_identification_syntaxes_json_ = new TTCN_JSONdescriptor(false, null, false, null, null, false, false, false, 0, null, false, json_string_escaping.ESCAPE_AS_SHORT);
	...
	public static final TTCN_Typedescriptor TitanExternal_identification_syntaxes_transfer_descr_ = new TTCN_Typedescriptor("EXTERNAL.identification.syntaxes.transfer", TitanObjectid.TitanObjectid_json_);
	 ...
	 */
	public boolean operator_equals( final TitanExternal_identification_syntaxes other_value) {
	...
	public boolean operator_equals(final Base_Type other_value) {
		if (other_value instanceof TitanExternal_identification_syntaxes ) {
			return operator_equals((TitanExternal_identification_syntaxes) other_value);
		}

		throw new TtcnError(MessageFormat.format("Internal Error: value `{0}'' can not be cast to EXTERNAL.identification.syntaxes", other_value));
	}
	 ...
	 */
	public boolean operator_not_equals( final TitanExternal_identification_syntaxes other_value) {
	...
	public int JSON_encode(final TTCN_Typedescriptor p_td, final JSON_Tokenizer p_tok, final boolean p_parent_is_map) {
		if (!is_bound()) {
			TTCN_EncDec_ErrorContext.error(error_type.ET_UNBOUND, "Encoding an unbound value of type EXTERNAL.identification.syntaxes.");
			return -1;
		}
	...
	/**
	 * The encoder function for type EXTERNAL.identification.syntaxes.
	 *
	 * @param input_value
	 ...
	 * */
	public static void TitanExternal_identification_syntaxes_encoder(final TitanExternal_identification_syntaxes input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		...
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			...
			coding_name.log();
			throw new TtcnError(MessageFormat.format("Type `EXTERNAL.identification.syntaxes' does not support {0} encoding", TTCN_Logger.end_event_log2str()));
		}
		final TTCN_Buffer ttcnBuffer = new TTCN_Buffer();
		input_value.encode(TitanExternal_identification_syntaxes.TitanExternal_identification_syntaxes_descr_, ttcnBuffer, codingType, extra_options.get());
		ttcnBuffer.get_string(output_stream);
	}

	/**
	 * The decoder function for type EXTERNAL.identification.syntaxes. In case
	 ...
	 * */
	public static int TitanExternal_identification_syntaxes_decoder(final TitanOctetString input_stream, final TitanExternal_identification_syntaxes output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		...
		output_value.decode(TitanExternal_identification_syntaxes.TitanExternal_identification_syntaxes_descr_, ttcnBuffer, codingType, extra_options.get());
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanExternal_identification_syntaxes_abstract__encoder(final TitanObjectid input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static int TitanExternal_identification_syntaxes_abstract__decoder(final TitanOctetString input_stream, final TitanObjectid output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanExternal_identification_syntaxes_transfer_encoder(final TitanObjectid input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static int TitanExternal_identification_syntaxes_transfer_decoder(final TitanOctetString input_stream, final TitanObjectid output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
