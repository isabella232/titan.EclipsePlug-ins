...
public class TitanCharacter_String_identification_template extends Base_Template {
	...
	public TitanCharacter_String_identification_template assign( final Base_Type otherValue ) {
		...
		throw new TtcnError("Internal Error: value can not be cast to CHARACTER__STRING_identification.");
	}
	...
	public TitanCharacter_String_identification_template assign( final Base_Template otherValue ) {
		...
		throw new TtcnError("Internal Error: value can not be cast to CHARACTER__STRING_identification_template.");
	}

	// originally match
	public TitanBoolean match(final TitanCharacter_String_identification other_value) {
		return match(other_value, false);
	}

	// originally match
	public TitanBoolean match(final TitanCharacter_String_identification other_value, final boolean legacy) {
		...
		case OMIT_VALUE:
			return new TitanBoolean(false);
		case SPECIFIC_VALUE:
			TitanCharacter_String_identification.union_selection_type value_selection = other_value.get_selection();
	...
	public TitanBoolean match(final Base_Type otherValue, final boolean legacy) {
		...
		throw new TtcnError("Internal Error: The left operand of assignment is not of type CHARACTER__STRING_identification.");
	}
	...
	public TitanCharacter_String_identification valueOf() {
		...
		TitanCharacter_String_identification ret_val = new TitanCharacter_String_identification();
		switch(single_value_union_selection) {
		case ALT_Syntaxes:
	...
	public TitanCharacter_String_identification_template listItem(int list_index)  {
	...
	public TitanCharacter_String_identification_syntaxes_template constGetSyntaxes() {
		if (templateSelection != template_sel.SPECIFIC_VALUE) {
			throw new TtcnError("Accessing field field1 in a non-specific template of union type CHARACTER STRING.identification.");
		}
		if (single_value_union_selection != TitanCharacter_String_identification.union_selection_type.ALT_Syntaxes) {
			throw new TtcnError("Accessing non-selected field field1 in a template of union type CHARACTER STRING.identification.");
		}
		return (TitanCharacter_String_identification_syntaxes_template)single_value;
	}
