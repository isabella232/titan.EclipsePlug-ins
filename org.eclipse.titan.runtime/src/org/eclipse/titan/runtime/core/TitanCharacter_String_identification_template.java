...
public class TitanCharacter_String_identification_template extends Base_Template {
	...
	private void copy_value(final TitanCharacter_String_identification other_value) {
		...
		case ALT_syntaxes:
			single_value = new TitanCharacter_String_identification_syntaxes_template(other_value.constGet_field_syntaxes());
			break;
		case ALT_syntax:
		...
		case ALT_context__negotiation:
			single_value = new TitanCharacter_String_identification_context__negotiation_template(other_value.constGet_field_context__negotiation());
			break;
	...
	public void clean_up() {
		...
		case SPECIFIC_VALUE:
			switch (single_value_union_selection) {
			case ALT_syntaxes:
				((TitanCharacter_String_identification_syntaxes_template)single_value).clean_up();
				break;
			case ALT_syntax:
			...
			case ALT_presentation__context__id:
				...
				break;
			case ALT_context__negotiation:
				((TitanCharacter_String_identification_context__negotiation_template)single_value).clean_up();
				break;
			case ALT_transfer__syntax:
				((TitanObjectid_template)single_value).clean_up();
				break;
	...
	@Override
	public TitanCharacter_String_identification_template operator_assign(final template_sel otherValue ) {
	 ...
	 */
	public TitanCharacter_String_identification_template operator_assign(final TitanCharacter_String_identification otherValue ) {
		clean_up();
	 ...
	 * @return the new template object.
	 */
	public TitanCharacter_String_identification_template operator_assign(final TitanCharacter_String_identification_template otherValue ) {
		if (otherValue != this) {
			clean_up();
	...
	@Override
	public TitanCharacter_String_identification_template operator_assign(final Base_Type otherValue ) {
	...
	@Override
	public TitanCharacter_String_identification_template operator_assign(final Base_Template otherValue ) {
		if (otherValue instanceof TitanCharacter_String_identification_template) {
			return operator_assign((TitanCharacter_String_identification_template)otherValue);
		}
	...
	public boolean match(final TitanCharacter_String_identification other_value, final boolean legacy) {
		...
		case SPECIFIC_VALUE:
			...
			case ALT_syntaxes:
				return ((TitanCharacter_String_identification_syntaxes_template)single_value).match(other_value.get_field_syntaxes(), legacy);
			case ALT_syntax:
			...
			case ALT_context__negotiation:
				return ((TitanCharacter_String_identification_context__negotiation_template)single_value).match(other_value.get_field_context__negotiation(), legacy);
			case ALT_transfer__syntax:
	...
	public boolean is_value() {
		...
		switch (single_value_union_selection) {
		case ALT_syntaxes:
			return ((TitanCharacter_String_identification_syntaxes_template)single_value).is_value();
		case ALT_syntax:
			return ((TitanObjectid_template)single_value).is_value();
		case ALT_presentation__context__id:
			return ((TitanInteger_template)single_value).is_value();
		case ALT_context__negotiation:
			return ((TitanCharacter_String_identification_context__negotiation_template)single_value).is_value();
		case ALT_transfer__syntax:
			return ((TitanObjectid_template)single_value).is_value();
		case ALT_fixed:
	...
	public TitanCharacter_String_identification valueof() {
		...
		switch (single_value_union_selection) {
		case ALT_syntaxes:
			ret_val.get_field_syntaxes().operator_assign(((TitanCharacter_String_identification_syntaxes_template)single_value).valueof());
			break;
		case ALT_syntax:
		...
		case ALT_presentation__context__id:
			...
			break;
		case ALT_context__negotiation:
			ret_val.get_field_context__negotiation().operator_assign(((TitanCharacter_String_identification_context__negotiation_template)single_value).valueof());
			break;
		case ALT_transfer__syntax:
	 ...
	 * */
	public TitanCharacter_String_identification_syntaxes_template get_field_syntaxes() {
	 ...
	 * @return field syntaxes.
	 * */
	public TitanCharacter_String_identification_syntaxes_template constGet_field_syntaxes() {
	 ...
	 * */
	public TitanCharacter_String_identification_context__negotiation_template get_field_context__negotiation() {
	 ...
	 * @return field context-negotiation.
	 * */
	public TitanCharacter_String_identification_context__negotiation_template constGet_field_context__negotiation() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
	...
	public void check_restriction(final template_res restriction, final String name, final boolean legacy) {
		...
		throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "CHARACTER STRING.identification" : name));
	}
}