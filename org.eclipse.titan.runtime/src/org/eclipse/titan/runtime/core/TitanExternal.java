...
public class TitanExternal extends Base_Type {
	 ...
	 */
	public boolean operator_equals( final TitanExternal other_value) {
	...
	public boolean operator_equals(final Base_Type other_value) {
		if (other_value instanceof TitanExternal ) {
			return operator_equals((TitanExternal) other_value);
		}
	 ...
	 */
	public boolean operator_not_equals( final TitanExternal other_value) {
	...
	public void set_param(final Module_Parameter param) {
		...
		case MP_Value_List:
			if (param.get_size() > 3) {
				param.error(MessageFormat.format("set value of type EXTERNAL has 3 fields but list value has {0} fields.", param.get_size()));
			}
	 ...
	 * */
	public static void TitanExternal_data__value_encoder(final TitanOctetString input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
	 ...
	 * */
	public static TitanInteger TitanExternal_data__value_decoder( final TitanOctetString input_stream, final TitanOctetString output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
