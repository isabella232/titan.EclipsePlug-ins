...
public class TitanExternal extends Base_Type {
	 ...
	 * */
	public static int TitanExternal_data__value_decoder(final TitanOctetString input_stream, final TitanOctetString output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
