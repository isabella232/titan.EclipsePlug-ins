...
public class TitanEmbedded_PDV_identification_template extends Base_Template {
	...
	private void copy_value(final TitanEmbedded_PDV_identification other_value) {
		...
		case ALT_syntaxes:
			single_value = new TitanEmbedded_PDV_identification_syntaxes_template(other_value.constGet_syntaxes());
			break;
		case ALT_syntax:
		...
		case ALT_context__negotiation:
			single_value = new TitanEmbedded_PDV_identification_context__negotiation_template(other_value.constGet_context__negotiation());
			break;
	...
	public boolean match(final TitanEmbedded_PDV_identification other_value, final boolean legacy) {
		...
		case SPECIFIC_VALUE:
			...
			case ALT_syntaxes:
				return ((TitanEmbedded_PDV_identification_syntaxes_template)single_value).match(other_value.get_syntaxes(), legacy);
			case ALT_syntax:
			...
			case ALT_context__negotiation:
				return ((TitanEmbedded_PDV_identification_context__negotiation_template)single_value).match(other_value.get_context__negotiation(), legacy);
			case ALT_transfer__syntax:
	 ...
	 * */
	public TitanEmbedded_PDV_identification_syntaxes_template get_syntaxes() {
	 ...
	 * @return field syntaxes.
	 * */
	public TitanEmbedded_PDV_identification_syntaxes_template constGet_syntaxes() {
	 ...
	 * */
	public TitanEmbedded_PDV_identification_context__negotiation_template get_context__negotiation() {
	 ...
	 * @return field context-negotiation.
	 * */
	public TitanEmbedded_PDV_identification_context__negotiation_template constGet_context__negotiation() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
