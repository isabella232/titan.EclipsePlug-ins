...
public class TitanEmbedded_PDV_identification_template extends Base_Template {
	...
	private void copy_value(final TitanEmbedded_PDV_identification other_value) {
		...
		case ALT_syntaxes:
			single_value = new TitanEmbedded_PDV_identification_syntaxes_template(other_value.constGet_field_syntaxes());
			break;
		case ALT_syntax:
		...
		case ALT_context__negotiation:
			single_value = new TitanEmbedded_PDV_identification_context__negotiation_template(other_value.constGet_field_context__negotiation());
			break;
	...
	public boolean match(final TitanEmbedded_PDV_identification other_value, final boolean legacy) {
		...
		case SPECIFIC_VALUE:
			...
			case ALT_syntaxes:
				return ((TitanEmbedded_PDV_identification_syntaxes_template)single_value).match(other_value.get_field_syntaxes(), legacy);
			case ALT_syntax:
			...
			case ALT_context__negotiation:
				return ((TitanEmbedded_PDV_identification_context__negotiation_template)single_value).match(other_value.get_field_context__negotiation(), legacy);
			case ALT_transfer__syntax:
	...
	public TitanEmbedded_PDV_identification valueof() {
		...
		switch (single_value_union_selection) {
		case ALT_syntaxes:
			ret_val.get_field_syntaxes().operator_assign(((TitanEmbedded_PDV_identification_syntaxes_template)single_value).valueof());
			break;
		case ALT_syntax:
		...
		case ALT_presentation__context__id:
			...
			break;
		case ALT_context__negotiation:
			ret_val.get_field_context__negotiation().operator_assign(((TitanEmbedded_PDV_identification_context__negotiation_template)single_value).valueof());
			break;
		case ALT_transfer__syntax:
	 ...
	 * */
	public TitanEmbedded_PDV_identification_syntaxes_template get_field_syntaxes() {
	 ...
	 * */
	public TitanEmbedded_PDV_identification_context__negotiation_template get_field_context__negotiation() {
	...
	public Module_Parameter get_param(final Module_Param_Name param_name) {
		if (param_name.next_name()) {
			...
			if (param_field.charAt(0) >= '0' && param_field.charAt(0) <= '9') {
				throw new TtcnError("Unexpected array index in module parameter reference, expected a valid field name for union template type `EMBEDDED PDV.identification'");
			}
			if ("syntaxes".equals(param_field)) {
