...
public class TitanCharacter_String_identification extends Base_Type {
	public static final TTCN_JSONdescriptor TitanCharacter_String_identification_json_ = new TTCN_JSONdescriptor(false, null, false, null, null, false, false, false, 0, null, false, json_string_escaping.ESCAPE_AS_SHORT);
	...
	public static final TTCN_Typedescriptor TitanCharacter_String_identification_syntax_descr_ = new TTCN_Typedescriptor("CHARACTER STRING.identification.syntax", TitanObjectid.TitanObjectid_json_);
	...
	public static final TTCN_Typedescriptor TitanCharacter_String_identification_presentation__context__id_descr_ = new TTCN_Typedescriptor("CHARACTER STRING.identification.presentation-context-id", TitanInteger.TitanInteger_json_);
	...
	public static final TTCN_Typedescriptor TitanCharacter_String_identification_transfer__syntax_descr_ = new TTCN_Typedescriptor("CHARACTER STRING.identification.transfer-syntax", TitanObjectid.TitanObjectid_json_);
	...
	public static final TTCN_Typedescriptor TitanCharacter_String_identification_fixed_descr_ = new TTCN_Typedescriptor("CHARACTER STRING.identification.fixed", TitanAsn_Null.TitanAsn_Null_json_);
	...
	public Module_Parameter get_param(final Module_Param_Name param_name) {
		...
		if (param_name.next_name()) {
			...
			if (param_field.charAt(0) >= '0' && param_field.charAt(0) <= '9') {
				throw new TtcnError("Unexpected array index in module parameter, expected a valid field name for union type `CHARACTER STRING.identification'");
			}
			if ("syntaxes".equals(param_field)) {
	...
	public int JSON_encode(final TTCN_Typedescriptor p_td, final JSON_Tokenizer p_tok, final boolean p_parent_is_map) {
		...
		case ALT_fixed:
			...
			break;
		default:
			TTCN_EncDec_ErrorContext.error(error_type.ET_UNBOUND, "Encoding an unbound value of type CHARACTER STRING.identification.");
			return -1;
		}
	...
	/**
	 * The encoder function for type CHARACTER STRING.identification.
	 *
	 * @param input_value
	 ...
	 * */
	public static void TitanCharacter_String_identification_encoder(final TitanCharacter_String_identification input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		...
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			...
			coding_name.log();
			throw new TtcnError(MessageFormat.format("Type `CHARACTER STRING.identification' does not support {0} encoding", TTCN_Logger.end_event_log2str()));
		}
		final TTCN_Buffer ttcnBuffer = new TTCN_Buffer();
		input_value.encode(TitanCharacter_String_identification.TitanCharacter_String_identification_descr_, ttcnBuffer, codingType, extra_options.get());
		ttcnBuffer.get_string(output_stream);
	}

	/**
	 * The decoder function for type CHARACTER STRING.identification. In case
	 ...
	 * */
	public static int TitanCharacter_String_identification_decoder(final TitanOctetString input_stream, final TitanCharacter_String_identification output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		...
		output_value.decode(TitanCharacter_String_identification.TitanCharacter_String_identification_descr_, ttcnBuffer, codingType, extra_options.get());
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanCharacter_String_identification_syntax_encoder(final TitanObjectid input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static int TitanCharacter_String_identification_syntax_decoder(final TitanOctetString input_stream, final TitanObjectid output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanCharacter_String_identification_transfer__syntax_encoder(final TitanObjectid input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static int TitanCharacter_String_identification_transfer__syntax_decoder(final TitanOctetString input_stream, final TitanObjectid output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanCharacter_String_identification_fixed_encoder(final TitanAsn_Null input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static int TitanCharacter_String_identification_fixed_decoder(final TitanOctetString input_stream, final TitanAsn_Null output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
