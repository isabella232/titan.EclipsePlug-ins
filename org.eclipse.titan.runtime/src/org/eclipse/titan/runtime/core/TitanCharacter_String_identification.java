...
public class TitanCharacter_String_identification extends Base_Type {
	...
	TitanCharacter_String_identification.union_selection_type union_selection;
	...
	public boolean isChosen(final TitanCharacter_String_identification.union_selection_type checked_selection) {
		...
		if (union_selection == union_selection_type.UNBOUND_VALUE) {
			throw new TtcnError("Performing ischosen() operation on an unbound value of union type CHARACTER STRING.identification.");
		}
	...
	//originally operator==
	public TitanBoolean operatorEquals( final TitanCharacter_String_identification otherValue ) {
		if (union_selection == union_selection_type.UNBOUND_VALUE) {
	...
	//originally operator!=
	public TitanBoolean operatorNotEquals( final TitanCharacter_String_identification otherValue ) {
	...
	public TitanCharacter_String_identification_syntaxes constGetSyntaxes() {
		if (union_selection != union_selection_type.ALT_Syntaxes) {
			throw new TtcnError("Using non-selected field field1 in a value of union type CHARACTER STRING.identification.");
		}
		return (TitanCharacter_String_identification_syntaxes)field;
	}
