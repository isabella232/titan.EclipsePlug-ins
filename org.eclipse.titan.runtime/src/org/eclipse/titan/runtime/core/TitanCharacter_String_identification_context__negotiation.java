...
public class TitanCharacter_String_identification_context__negotiation extends Base_Type {
	public static final TTCN_JSONdescriptor TitanCharacter_String_identification_context__negotiation_json_ = new TTCN_JSONdescriptor(false, null, false, null, null, false, false, false, 0, null, false, json_string_escaping.ESCAPE_AS_SHORT);
	...
	public static final TTCN_Typedescriptor TitanCharacter_String_identification_context__negotiation_presentation__context__id_descr_ = new TTCN_Typedescriptor("CHARACTER STRING.identification.context-negotiation.presentation-context-id", TitanInteger.TitanInteger_json_);
	...
	public static final TTCN_Typedescriptor TitanCharacter_String_identification_context__negotiation_transfer__syntax_descr_ = new TTCN_Typedescriptor("CHARACTER STRING.identification.context-negotiation.transfer-syntax", TitanObjectid.TitanObjectid_json_);
	 ...
	 */
	public boolean operator_not_equals( final TitanCharacter_String_identification_context__negotiation other_value) {
	...
	/**
	 * The encoder function for type CHARACTER STRING.identification.context-negotiation.
	 *
	 * @param input_value
	 ...
	 * */
	public static void TitanCharacter_String_identification_context__negotiation_encoder(final TitanCharacter_String_identification_context__negotiation input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		...
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			...
			coding_name.log();
			throw new TtcnError(MessageFormat.format("Type `CHARACTER STRING.identification.context-negotiation' does not support {0} encoding", TTCN_Logger.end_event_log2str()));
		}
		final TTCN_Buffer ttcnBuffer = new TTCN_Buffer();
		input_value.encode(TitanCharacter_String_identification_context__negotiation.TitanCharacter_String_identification_context__negotiation_descr_, ttcnBuffer, codingType, extra_options.get());
		ttcnBuffer.get_string(output_stream);
	}

	/**
	 * The decoder function for type CHARACTER STRING.identification.context-negotiation. In case
	 ...
	 * */
	public static int TitanCharacter_String_identification_context__negotiation_decoder(final TitanOctetString input_stream, final TitanCharacter_String_identification_context__negotiation output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		...
		output_value.decode(TitanCharacter_String_identification_context__negotiation.TitanCharacter_String_identification_context__negotiation_descr_, ttcnBuffer, codingType, extra_options.get());
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanCharacter_String_identification_context__negotiation_transfer__syntax_encoder(final TitanObjectid input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static int TitanCharacter_String_identification_context__negotiation_transfer__syntax_decoder(final TitanOctetString input_stream, final TitanObjectid output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
