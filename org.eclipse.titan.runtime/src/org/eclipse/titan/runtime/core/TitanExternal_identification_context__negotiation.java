...
public class TitanExternal_identification_context__negotiation extends Base_Type {
	 ...
	 */
	public boolean operator_equals( final TitanExternal_identification_context__negotiation otherValue) {
	...
	public boolean operator_equals(final Base_Type otherValue) {
		if (otherValue instanceof TitanExternal_identification_context__negotiation ) {
			return operator_equals((TitanExternal_identification_context__negotiation) otherValue);
		}
