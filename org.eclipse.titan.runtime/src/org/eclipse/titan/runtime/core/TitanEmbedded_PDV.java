...
public class TitanEmbedded_PDV extends Base_Type {
	...
	public static final TTCN_Typedescriptor TitanEmbedded_PDV_data__value_descr_ = new TTCN_Typedescriptor("EMBEDDED PDV.data-value", null, TitanOctetString.TitanOctetString_raw_, TitanOctetString.TitanOctetString_json_);
	 ...
	 * */
	public static void TitanEmbedded_PDV_data__value_encoder(final TitanOctetString input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
	 ...
	 * */
	public static TitanInteger TitanEmbedded_PDV_data__value_decoder( final TitanOctetString input_stream, final TitanOctetString output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
