...
public class TitanEmbedded_PDV_identification_syntaxes extends Base_Type {
	public static final TTCN_JSONdescriptor TitanEmbedded_PDV_identification_syntaxes_json_ = new TTCN_JSONdescriptor(false, null, false, null, null, false, false, false, 0, null, false, json_string_escaping.ESCAPE_AS_SHORT);
	public static final TTCN_Typedescriptor TitanEmbedded_PDV_identification_syntaxes_descr_ = new TTCN_Typedescriptor("EMBEDDED PDV.identification.syntaxes", TitanEmbedded_PDV_identification_syntaxes.TitanEmbedded_PDV_identification_syntaxes_json_);
	public static final TitanUniversalCharString TitanEmbedded_PDV_identification_syntaxes_default_coding = new TitanUniversalCharString("JSON");
	public static final TTCN_Typedescriptor TitanEmbedded_PDV_identification_syntaxes_abstract__descr_ = new TTCN_Typedescriptor("EMBEDDED PDV.identification.syntaxes.abstract", TitanObjectid.TitanObjectid_json_);
	public static final TitanUniversalCharString TitanEmbedded_PDV_identification_syntaxes_abstract__default_coding = new TitanUniversalCharString("JSON");
	public static final TTCN_Typedescriptor TitanEmbedded_PDV_identification_syntaxes_transfer_descr_ = new TTCN_Typedescriptor("EMBEDDED PDV.identification.syntaxes.transfer", TitanObjectid.TitanObjectid_json_);
	public static final TitanUniversalCharString TitanEmbedded_PDV_identification_syntaxes_transfer_default_coding = new TitanUniversalCharString("JSON");
	...
	/**
	 * The encoder function for type EMBEDDED PDV.identification.syntaxes.
	 *
	 * @param input_value
	 ...
	 * */
	public static void TitanEmbedded_PDV_identification_syntaxes_encoder(final TitanEmbedded_PDV_identification_syntaxes input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		...
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			...
			coding_name.log();
			throw new TtcnError(MessageFormat.format("Type `EMBEDDED PDV.identification.syntaxes' does not support {0} encoding", TTCN_Logger.end_event_log2str()));
		}
		final TTCN_Buffer ttcnBuffer = new TTCN_Buffer();
		input_value.encode(TitanEmbedded_PDV_identification_syntaxes.TitanEmbedded_PDV_identification_syntaxes_descr_, ttcnBuffer, codingType, extra_options.get());
		ttcnBuffer.get_string(output_stream);
	}

	/**
	 * The decoder function for type EMBEDDED PDV.identification.syntaxes. In case
	 ...
	 * */
	public static int TitanEmbedded_PDV_identification_syntaxes_decoder(final TitanOctetString input_stream, final TitanEmbedded_PDV_identification_syntaxes output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		...
		output_value.decode(TitanEmbedded_PDV_identification_syntaxes.TitanEmbedded_PDV_identification_syntaxes_descr_, ttcnBuffer, codingType, extra_options.get());
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanEmbedded_PDV_identification_syntaxes_abstract__encoder(final TitanObjectid input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static int TitanEmbedded_PDV_identification_syntaxes_abstract__decoder(final TitanOctetString input_stream, final TitanObjectid output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanEmbedded_PDV_identification_syntaxes_transfer_encoder(final TitanObjectid input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static int TitanEmbedded_PDV_identification_syntaxes_transfer_decoder(final TitanOctetString input_stream, final TitanObjectid output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
