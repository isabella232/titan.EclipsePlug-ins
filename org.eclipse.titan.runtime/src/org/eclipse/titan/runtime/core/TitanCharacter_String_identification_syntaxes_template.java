...
public class TitanCharacter_String_identification_syntaxes_template extends Base_Template {
	...
	public TitanBoolean match(final TitanCharacter_String_identification_syntaxes other_value) {
		return match(other_value, false);
	}

	public TitanBoolean match(final TitanCharacter_String_identification_syntaxes other_value, final boolean legacy) {
	...
	public void log_match(final TitanCharacter_String_identification_syntaxes match_value, boolean legacy) {
