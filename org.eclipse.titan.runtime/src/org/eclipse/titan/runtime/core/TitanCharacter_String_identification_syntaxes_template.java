...
public class TitanCharacter_String_identification_syntaxes_template extends Base_Template {
	...
	public TitanObjectid_template constGetAbstract_() {
		if (templateSelection != template_sel.SPECIFIC_VALUE) {
			throw new TtcnError("Accessing field abstract_ of a non-specific template of type CHARACTER STRING.identification.syntaxes.");
		}
		return abstract_;
	}
	...
	public TitanCharacter_String_identification_syntaxes_template assign(final Base_Type otherValue) {
		...
		throw new TtcnError(MessageFormat.format("Internal Error: value `CHARACTER__STRING_identification_syntaxes' can not be cast to {1}", otherValue));
	}
	...
	public TitanCharacter_String_identification_syntaxes_template assign(final Base_Template otherValue) {
		...
		throw new TtcnError(MessageFormat.format("Internal Error: value `CHARACTER__STRING_identification_syntaxes' can not be cast to {1}_template", otherValue));
	}
	...
	public TitanCharacter_String_identification_syntaxes valueOf() {
		...
		TitanCharacter_String_identification_syntaxes ret_val = new TitanCharacter_String_identification_syntaxes();
	...
	public TitanCharacter_String_identification_syntaxes_template listItem(int list_index) {
	...
	public TitanBoolean match(TitanCharacter_String_identification_syntaxes other_value) {
		return match(other_value, false);
	}

	public TitanBoolean match(TitanCharacter_String_identification_syntaxes other_value, boolean legacy) {
		return new TitanBoolean(match_(other_value, legacy));
	}

	private boolean match_(TitanCharacter_String_identification_syntaxes other_value, boolean legacy) {
	...
	public TitanBoolean match(final Base_Type otherValue, final boolean legacy) {
		...
		throw new TtcnError("Internal Error: The left operand of assignment is not of type CHARACTER__STRING_identification_syntaxes.");
	}
