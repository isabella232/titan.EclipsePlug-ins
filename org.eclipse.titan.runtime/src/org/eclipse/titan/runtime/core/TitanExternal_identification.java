...
public class TitanExternal_identification extends Base_Type {
	public static final TTCN_JSONdescriptor TitanExternal_identification_json_ = new TTCN_JSONdescriptor(false, null, false, null, null, false, false, false, 0, null, false, json_string_escaping.ESCAPE_AS_SHORT);
	public static final TTCN_Typedescriptor TitanExternal_identification_descr_ = new TTCN_Typedescriptor("EXTERNAL.identification", TitanExternal_identification.TitanExternal_identification_json_);
	public static final TitanUniversalCharString TitanExternal_identification_default_coding = new TitanUniversalCharString("JSON");
	public static final TTCN_Typedescriptor TitanExternal_identification_syntax_descr_ = new TTCN_Typedescriptor("EXTERNAL.identification.syntax", TitanObjectid.TitanObjectid_json_);
	public static final TitanUniversalCharString TitanExternal_identification_syntax_default_coding = new TitanUniversalCharString("JSON");
	public static final TTCN_Typedescriptor TitanExternal_identification_presentation__context__id_descr_ = new TTCN_Typedescriptor("EXTERNAL.identification.presentation-context-id", TitanInteger.TitanInteger_json_);
	public static final TitanUniversalCharString TitanExternal_identification_presentation__context__id_default_coding = new TitanUniversalCharString("JSON");
	public static final TTCN_Typedescriptor TitanExternal_identification_transfer__syntax_descr_ = new TTCN_Typedescriptor("EXTERNAL.identification.transfer-syntax", TitanObjectid.TitanObjectid_json_);
	public static final TitanUniversalCharString TitanExternal_identification_transfer__syntax_default_coding = new TitanUniversalCharString("JSON");
	public static final TTCN_Typedescriptor TitanExternal_identification_fixed_descr_ = new TTCN_Typedescriptor("EXTERNAL.identification.fixed", TitanAsn_Null.TitanAsn_Null_json_);
	public static final TitanUniversalCharString TitanExternal_identification_fixed_default_coding = new TitanUniversalCharString("JSON");
	/**
	...
	private void copy_value(final TitanExternal_identification other_value) {
		...
		case ALT_syntaxes:
			field = new TitanExternal_identification_syntaxes((TitanExternal_identification_syntaxes)other_value.field);
			break;
		case ALT_syntax:
		...
		case ALT_context__negotiation:
			field = new TitanExternal_identification_context__negotiation((TitanExternal_identification_context__negotiation)other_value.field);
			break;
	...
	public int JSON_encode(final TTCN_Typedescriptor p_td, final JSON_Tokenizer p_tok, final boolean p_parent_is_map) {
		...
		case ALT_syntaxes:
			...
			enc_len += get_field_syntaxes().JSON_encode(TitanExternal_identification_syntaxes.TitanExternal_identification_syntaxes_descr_, p_tok);
			break;
		case ALT_syntax:
			if (!as_value) {
		...
		case ALT_context__negotiation:
			...
			enc_len += get_field_context__negotiation().JSON_encode(TitanExternal_identification_context__negotiation.TitanExternal_identification_context__negotiation_descr_, p_tok);
			break;
		case ALT_transfer__syntax:
			if (!as_value) {
		...
		case ALT_fixed:
			...
			break;
		default:
			TTCN_EncDec_ErrorContext.error(error_type.ET_UNBOUND, "Encoding an unbound value of type EXTERNAL.identification.");
			return -1;
		}
	...
	public int JSON_decode(final TTCN_Typedescriptor p_td, final JSON_Tokenizer p_tok, final boolean p_silent, final boolean p_parent_is_map, final int p_chosen_field) {
		if (0 <= p_chosen_field && 6 > p_chosen_field) {
			...
			case 0:
				return get_field_syntaxes().JSON_decode(TitanExternal_identification_syntaxes.TitanExternal_identification_syntaxes_descr_, p_tok, true);
			case 1:
			...
			case 3:
				return get_field_context__negotiation().JSON_decode(TitanExternal_identification_context__negotiation.TitanExternal_identification_context__negotiation_descr_, p_tok, true);
			case 4:
		...
		if (p_td.json.isAs_value()) {
			...
			case JSON_TOKEN_OBJECT_START: {
				p_tok.set_buf_pos(buf_pos);
				ret_val = get_field_syntaxes().JSON_decode(TitanExternal_identification_syntaxes.TitanExternal_identification_syntaxes_descr_, p_tok, true);
				if (0 <= ret_val) {
					return ret_val;
				}
				p_tok.set_buf_pos(buf_pos);
				ret_val = get_field_context__negotiation().JSON_decode(TitanExternal_identification_context__negotiation.TitanExternal_identification_context__negotiation_descr_, p_tok, true);
				if (0 <= ret_val) {
					return ret_val;
				}
				if (!p_silent) {
			...
			if (json_token_t.JSON_TOKEN_NAME != j_token.get()) {
				...
				if (8 == name_len.get() && "syntaxes".equals(fld_name.substring(0,name_len.get()))) {
					final int ret_val = get_field_syntaxes().JSON_decode(TitanExternal_identification_syntaxes.TitanExternal_identification_syntaxes_descr_, p_tok, p_silent);
					if (0 > ret_val) {
					...
					final int ret_val = get_field_context__negotiation().JSON_decode(TitanExternal_identification_context__negotiation.TitanExternal_identification_context__negotiation_descr_, p_tok, p_silent);
					if (0 > ret_val) {
						if (JSON.JSON_ERROR_INVALID_TOKEN == ret_val) {
	...
	/**
	 * The encoder function for type EXTERNAL.identification.
	 *
	 * @param input_value
	 ...
	 * */
	public static void TitanExternal_identification_encoder(final TitanExternal_identification input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		...
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			...
			coding_name.log();
			throw new TtcnError(MessageFormat.format("Type `EXTERNAL.identification' does not support {0} encoding", TTCN_Logger.end_event_log2str()));
		}
		final TTCN_Buffer ttcnBuffer = new TTCN_Buffer();
		input_value.encode(TitanExternal_identification.TitanExternal_identification_descr_, ttcnBuffer, codingType, extra_options.get());
		ttcnBuffer.get_string(output_stream);
	}

	/**
	 * The decoder function for type EXTERNAL.identification. In case
	...
	public static int TitanExternal_identification_decoder(final TitanOctetString input_stream, final TitanExternal_identification output_value, final TitanUniversalCharString coding_name) {
		...
		output_value.decode(TitanExternal_identification.TitanExternal_identification_descr_, ttcnBuffer, codingType, extra_options.get());
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanExternal_identification_syntax_encoder(final TitanObjectid input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanExternal_identification_transfer__syntax_encoder(final TitanObjectid input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanExternal_identification_fixed_encoder(final TitanAsn_Null input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
