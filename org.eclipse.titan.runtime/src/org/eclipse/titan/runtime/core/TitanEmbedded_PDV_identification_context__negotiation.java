...
public class TitanEmbedded_PDV_identification_context__negotiation extends Base_Type {
	...
	public static final TTCN_Typedescriptor TitanEmbedded_PDV_identification_context__negotiation_presentation__context__id_descr_ = new TTCN_Typedescriptor("EMBEDDED PDV.identification.context-negotiation.presentation-context-id", JSON.TitanInteger_json_);
	public static final TitanUniversalCharString TitanEmbedded_PDV_identification_context__negotiation_presentation__context__id_default_coding = new TitanUniversalCharString("JSON");
	public static final TTCN_Typedescriptor TitanEmbedded_PDV_identification_context__negotiation_transfer__syntax_descr_ = new TTCN_Typedescriptor("EMBEDDED PDV.identification.context-negotiation.transfer-syntax", JSON.TitanObjectid_json_);
	public static final TitanUniversalCharString TitanEmbedded_PDV_identification_context__negotiation_transfer__syntax_default_coding = new TitanUniversalCharString("JSON");
	 ...
	 */
	public boolean operator_not_equals( final TitanEmbedded_PDV_identification_context__negotiation other_value) {
	...
	public int JSON_encode(final TTCN_Typedescriptor p_td, final JSON_Tokenizer p_tok, final boolean p_parent_is_map) {
		if (!is_bound()) {
			TTCN_EncDec_ErrorContext.error(error_type.ET_UNBOUND, "Encoding an unbound value of type EMBEDDED PDV.identification.context-negotiation.");
			return -1;
		}
	...
	/**
	 * The encoder function for type EMBEDDED PDV.identification.context-negotiation.
	 *
	 * @param input_value
	 ...
	 * */
	public static void TitanEmbedded_PDV_identification_context__negotiation_encoder(final TitanEmbedded_PDV_identification_context__negotiation input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		...
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			...
			coding_name.log();
			throw new TtcnError(MessageFormat.format("Type `EMBEDDED PDV.identification.context-negotiation' does not support {0} encoding", TTCN_Logger.end_event_log2str()));
		}
		final TTCN_Buffer ttcnBuffer = new TTCN_Buffer();
		input_value.encode(TitanEmbedded_PDV_identification_context__negotiation.TitanEmbedded_PDV_identification_context__negotiation_descr_, ttcnBuffer, codingType, extra_options.get());
		ttcnBuffer.get_string(output_stream);
	}

	/**
	 * The decoder function for type EMBEDDED PDV.identification.context-negotiation. In case
	 ...
	 * */
	public static TitanInteger TitanEmbedded_PDV_identification_context__negotiation_decoder( final TitanOctetString input_stream, final TitanEmbedded_PDV_identification_context__negotiation output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		...
		output_value.decode(TitanEmbedded_PDV_identification_context__negotiation.TitanEmbedded_PDV_identification_context__negotiation_descr_, ttcnBuffer, codingType, extra_options.get());
	 ...
	 *                the name of the coding to use.
	 * */
	public static void TitanEmbedded_PDV_identification_context__negotiation_transfer__syntax_encoder(final TitanObjectid input_value, final TitanOctetString output_stream, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, true);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
	 ...
	 *         case of error (incomplete message or length)
	 * */
	public static TitanInteger TitanEmbedded_PDV_identification_context__negotiation_transfer__syntax_decoder( final TitanOctetString input_stream, final TitanObjectid output_value, final TitanUniversalCharString coding_name) {
		final AtomicInteger extra_options = new AtomicInteger(0);
		final TTCN_EncDec.coding_type codingType = TTCN_EncDec.get_coding_from_str(coding_name, extra_options, false);
		if (codingType != TTCN_EncDec.coding_type.CT_JSON) {
			TTCN_Logger.begin_event_log2str();
