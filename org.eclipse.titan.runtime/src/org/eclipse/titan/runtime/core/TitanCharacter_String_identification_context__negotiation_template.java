...
public class TitanCharacter_String_identification_context__negotiation_template extends Base_Template {
	...
	public TitanBoolean match(final TitanCharacter_String_identification_context__negotiation other_value) {
		return match(other_value, false);
	}

	public TitanBoolean match(final TitanCharacter_String_identification_context__negotiation other_value, final boolean legacy) {
		return new TitanBoolean(match_(other_value, legacy));
	}

	private boolean match_(final TitanCharacter_String_identification_context__negotiation other_value, final boolean legacy) {
