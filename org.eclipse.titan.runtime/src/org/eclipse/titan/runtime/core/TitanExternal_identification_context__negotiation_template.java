...
public class TitanExternal_identification_context__negotiation_template extends Base_Template {
	...
	public TitanBoolean match(final TitanExternal_identification_context__negotiation other_value) {
		return match(other_value, false);
	}

	public TitanBoolean match(final TitanExternal_identification_context__negotiation other_value, final boolean legacy) {
