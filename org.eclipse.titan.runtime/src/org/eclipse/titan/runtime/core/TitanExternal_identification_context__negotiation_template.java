...
public class TitanExternal_identification_context__negotiation_template extends Base_Template {
	 ...
	 * */
	public TitanExternal_identification_context__negotiation_template(final template_sel otherValue ) {
		super( otherValue );
	 ...
	 *                the value to initialize to.
	 * */
	public TitanExternal_identification_context__negotiation_template( final Optional<TitanExternal_identification_context__negotiation> otherValue ) {
	...
	private void copy_template(final TitanExternal_identification_context__negotiation_template other_value) {
	...
	public void check_restriction(final template_res restriction, final String name, final boolean legacy) {
		...
		throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "EXTERNAL.identification.context-negotiation" : name));
	}
}