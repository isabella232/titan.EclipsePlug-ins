...
public class TitanExternal_identification_context__negotiation_template extends Base_Template {
	...
	public TitanInteger_template constGetPresentation__context__id() {
		if (templateSelection != template_sel.SPECIFIC_VALUE) {
			throw new TtcnError("Accessing field presentation__context__id of a non-specific template of type EXTERNAL.identification.context-negotiation.");
		}
		return presentation__context__id;
	}
	...
	public TitanObjectid_template constGetTransfer__syntax() {
		if (templateSelection != template_sel.SPECIFIC_VALUE) {
			throw new TtcnError("Accessing field transfer__syntax of a non-specific template of type EXTERNAL.identification.context-negotiation.");
		}
		return transfer__syntax;
	}
	...
	public TitanExternal_identification_context__negotiation_template assign(final Base_Type otherValue) {
		...
		throw new TtcnError(MessageFormat.format("Internal Error: value `EXTERNAL_identification_context__negotiation' can not be cast to {1}", otherValue));
	}
	...
	public TitanExternal_identification_context__negotiation_template assign(final Base_Template otherValue) {
		...
		throw new TtcnError(MessageFormat.format("Internal Error: value `EXTERNAL_identification_context__negotiation' can not be cast to {1}_template", otherValue));
	}
	...
	public TitanExternal_identification_context__negotiation valueOf() {
		...
		TitanExternal_identification_context__negotiation ret_val = new TitanExternal_identification_context__negotiation();
	...
	public TitanExternal_identification_context__negotiation_template listItem(int list_index) {
	...
	public TitanBoolean match(TitanExternal_identification_context__negotiation other_value) {
		return match(other_value, false);
	}

	public TitanBoolean match(TitanExternal_identification_context__negotiation other_value, boolean legacy) {
		return new TitanBoolean(match_(other_value, legacy));
	}

	private boolean match_(TitanExternal_identification_context__negotiation other_value, boolean legacy) {
	...
	public TitanBoolean match(final Base_Type otherValue, final boolean legacy) {
		...
		throw new TtcnError("Internal Error: The left operand of assignment is not of type EXTERNAL_identification_context__negotiation.");
	}
