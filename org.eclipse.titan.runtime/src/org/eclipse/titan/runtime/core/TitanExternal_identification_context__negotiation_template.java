...
public class TitanExternal_identification_context__negotiation_template extends Base_Template {
	...
	public TitanExternal_identification_context__negotiation_template operator_assign(final Base_Type otherValue) {
		...
		throw new TtcnError(MessageFormat.format("Internal Error: value `{0}'' can not be cast to `TitanExternal_identification_context__negotiation''", otherValue));
	}
	...
	public TitanExternal_identification_context__negotiation_template operator_assign(final Base_Template otherValue) {
		...
		throw new TtcnError(MessageFormat.format("Internal Error: value `{0}'' can not be cast to `TitanExternal_identification_context__negotiation_template''", otherValue));
	}
	...
	private void copy_template(final TitanExternal_identification_context__negotiation_template other_value) {
		...
		case COMPLEMENTED_LIST:
			...
			break;
		default:
			throw new TtcnError("Copying an uninitialized/unsupported template of type EXTERNAL.identification.context-negotiation.");
		}
