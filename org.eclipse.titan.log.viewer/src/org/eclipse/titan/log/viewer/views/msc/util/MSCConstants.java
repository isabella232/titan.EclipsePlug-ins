...
public final class MSCConstants {
	...
	public static Resource getResource(final String resourceKey) {
		...
		case COLOR_LIGHTER_GREY:
			return new Color(Display.getDefault(), 220, 220, 220);
		...
		case COLOR_DARK_GREY:
			return new Color(Display.getDefault(), 100, 100, 100);
		case COLOR_SOFT_BLUE:
			return new Color(Display.getDefault(), 135, 155, 165);
		...
		case COLOR_EVENT_ORANGE:
			return new Color(Display.getDefault(), 255, 153, 0);
		case COLOR_EVENT_LIME:
			return new Color(Display.getDefault(), 204, 255, 0);
		case COLOR_EVENT_DARK_BLUE:
			return new Color(Display.getDefault(), 51, 0, 102);
		case COLOR_EVENT_LIGHT_YELLOW:
			return new Color(Display.getDefault(), 255, 255, 204);
		case COLOR_EVENT_LIGHT_ORANGE:
			return new Color(Display.getDefault(), 255, 204, 102);
		case COLOR_EVENT_CORAL:
			return new Color(Display.getDefault(), 255, 127, 80);
		case COLOR_EVENT_FUCHSIA:
			return new Color(Display.getDefault(), 255, 0, 255);
		case COLOR_EVENT_LIGHT_GREEN:
			return new Color(Display.getDefault(), 102, 255, 102);
		case COLOR_EVENT_PINK:
			return new Color(Display.getDefault(), 255, 102, 204);
		case COLOR_EVENT_LIGHT_BLUE:
			return new Color(Display.getDefault(), 0, 204, 255);
		case COLOR_EVENT_DARK_PURPLE:
			return new Color(Display.getDefault(), 102, 0, 153);
		case COLOR_EVENT_PALE_PURPLE:
			return new Color(Display.getDefault(), 255, 204, 255);
		case COLOR_VERDICT_FAIL_ERROR:
			return new Color(Display.getDefault(), 255, 102, 102);
		case COLOR_VERDICT_INCONC:
			return new Color(Display.getDefault(), 232, 242, 254);
		case COLOR_VERDICT_PASS:
			return new Color(Display.getDefault(), 102, 204, 102);
		case COLOR_VERDICT_NONE:
			return new Color(Display.getDefault(), 200, 200, 200);

			// Fonts
		case FONT_DEFAULT:
			return new Font(Display.getDefault(), Display.getDefault().getSystemFont().getFontData()[0].getName(), Display.getDefault()
					.getSystemFont().getFontData()[0].getHeight(), SWT.NORMAL);
		case FONT_BOLD:
			return new Font(Display.getDefault(), Display.getDefault().getSystemFont().getFontData()[0].getName(), Display.getDefault()
					.getSystemFont().getFontData()[0].getHeight(), SWT.BOLD);
		default:
			break;
		}
		return resource;
