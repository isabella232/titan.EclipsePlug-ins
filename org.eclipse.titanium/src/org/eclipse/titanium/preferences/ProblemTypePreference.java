...
public enum ProblemTypePreference {
	...
	PRIVATE_COMPONENT_VARIABLE_ACCESS("Report the private component variable access from an another module.", EnumSet.of(CodeSmellType.PRIVATE_COMPONENT_VARIABLE_ACCESS)),
